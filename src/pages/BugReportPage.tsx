  ...
  return (
    <div className="animate-in">
      ...
      <div className="input-group">
        ...
        <textarea
          className="input"
          placeholder="e.g. This product was marked unsafe but it's certified gluten-free. The barcode scanned correctly but the result seems incorrect...\n\nIf possible, please attach a screenshot in your email."
          value={description}
